...
import com.spark.helloword.SparkTestUtil.UrlResponse;
...
public class GenericSecureIntegrationTest {
    ...
    public void testGetHi() throws Exception {
        ...
        Assert.assertEquals("shl", jsonObject.get("userName"));
        Assert.assertEquals("北京", jsonObject.get("address"));
        Assert.assertEquals("123456", jsonObject.get("password"));
        Assert.assertEquals(25, jsonObject.getInt("age"));
    }
